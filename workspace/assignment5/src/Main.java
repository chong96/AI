...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.printf("Backtracking: %d\n", endTime - startTime);
		System.out.println();
		
		startTime = System.nanoTime();
		AC3.ac3(csp);
		solver = new BacktrackingCSPSolver();
		...
		System.out.printf("Backtracking with AC3: %d\n", endTime - startTime);
		System.out.println();
		
		startTime = System.nanoTime();
		solver = new ForwardCheckingCSPSolver();
		result = solver.solve(csp);
		if(result == null) {
			System.out.println("Found no solution!");
		} else {
		...
		endTime = System.nanoTime();
		System.out.printf("Backtracking with forward checking: %d\n", endTime - startTime);
		System.out.println();
		
		startTime = System.nanoTime();
		solver = new MinConflicts();
		result = solver.solve(csp);
		if(result == null) {
			System.out.println("Found no solution!");
		} else {
		...
		endTime = System.nanoTime();
		System.out.printf("Min Conflicts: %d\n", endTime - startTime);
